...
<?php
    ...
    <section class="hero">
        <main class="content">
            <h1>Paket Data</h1>
            <p>Temukan paket data dengan harga terbaik.</p>
            <button class="cta" id="openModal">Lihat Paket</button>
        </main>
    </section>
    ...
    <div id="paketModal" class="modal">
        <div class="modal-content">
            ...
            <div id="paketList">
                ...
                $sql = "SELECT id, paket, harga FROM paket";
                        ...
                        echo "<tr>
                                ...
                                <td>
                                    <form method='POST' action='tambah_keranjang.php'>
                                        ...
                                        <input type='hidden' name='jenis' value='paket'>
